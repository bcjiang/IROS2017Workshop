...
Modular framework is one key for CoSTAR cross-platform implementation and it is achieved through the concept of \textit{Components}. Each component $C$ is associated with a set $(I,O,s,p,u)$: 
